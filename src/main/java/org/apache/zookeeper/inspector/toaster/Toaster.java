...
public class Toaster {
	...
	private boolean useAlwaysOnTop = true;
	...
	class Animation extends Thread {
		final SingleToaster toaster;

		Animation(SingleToaster toaster) {
		 ...
		 */
		void animateVertically(int posx, int fromY, int toY) throws InterruptedException {
	 ...
	 */
	private Font getToasterMessageFont() {
