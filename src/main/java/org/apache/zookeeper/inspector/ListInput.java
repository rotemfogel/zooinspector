...
public class ListInput extends JPanel implements ListSelectionListener,
	...
	private ListInput(String[] data, String title) {
		setLayout(null);
...
//      System.out.println("keyPressed: " + e.getKeyCode());
	...
	private void setDisplayedMnemonic(char ch) {
		label.setDisplayedMnemonic(ch);
	}
	
	private void setSelected(String sel) {
	...
	class ListInputLabel extends JLabel {
		ListInputLabel(String text, int alignment) {
	...
	class AccessibleOpenList extends AccessibleJComponent {
